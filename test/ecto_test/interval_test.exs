defmodule Ecto.Integration.IntervalTest do
  ...
  #            TestRepo.all(
  #              from u in Usec,
  #                select: datetime_add(type(^datetime, :utc_datetime_usec), 0, "millisecond")
  #            )

  #   assert [^datetime] =
  #            TestRepo.all(
  #              from u in Usec, select: datetime_add(u.utc_datetime_usec, 150, "millisecond")
  #            )
  ...
  #   assert [^datetime] =
  #            TestRepo.all(
  #              from u in Usec, select: datetime_add(u.utc_datetime_usec, ^150.0, "millisecond")
  #            )

  #   assert [^datetime] =
  #            TestRepo.all(
  #              from u in Usec, select: datetime_add(u.utc_datetime_usec, ^dec, "millisecond")
  #            )
  # end
  ...
  #            TestRepo.all(
  #              from u in Usec,
  #                select: datetime_add(type(^datetime, :naive_datetime_usec), 0, "millisecond")
  #            )

  #   assert [^datetime] =
  #            TestRepo.all(
  #              from u in Usec, select: datetime_add(u.naive_datetime_usec, 150, "millisecond")
  #            )

  #   assert [^datetime] =
  #            TestRepo.all(
  #              from u in Usec, select: datetime_add(u.naive_datetime_usec, 150.0, "millisecond")
  #            )
  ...
  #   assert [^datetime] =
  #            TestRepo.all(
  #              from u in Usec, select: datetime_add(u.naive_datetime_usec, ^dec, "millisecond")
  #            )
  # end
end
